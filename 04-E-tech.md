...
一般来讲，只要不是极品坑的近两三年的笔记本，都没有什么大问题。
...
严格意义上，不需要严格遵守上面的要求（可能会贵/难），这只是从我们日常使用的角度上做的一些建议（与学校无关）。以下是一些 Windows 阵营笔记本推荐，请不要全盘接受，需要你自己来评判：
...
这个推荐显然不详细，请从此按钮跳转到知乎，看看大佬的推荐吧：

<a href="https://zhuanlan.zhihu.com/p/74132830" class=" btn blue darken-1 white-text" target="_zhihu">转到型号推荐</a>

下面一段有些长，可能也略难懂，如果感兴趣可以看一看；不感兴趣请直接 <a href="#小结" class=" btn red darken-3 white-text">转到页面底端</a> 。
